...
export const Route = createFileRoute("/_public/produtos")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Planner, Criador Universal, CRM, Financeiro, Marketplace, Automação e IA.",
      },
...
const items = [
  {
    ...
    name: "Planner",
    badge: "Em breve",
    desc: "Projeto 3D, catálogo, orçamento, produção e CNC com IA.",
  ...
  },
  {
    ...
    badge: "Em breve",
    desc: "Sites, apps, sistemas e portais gerados por IA.",
  ...
  },
  {
    ...
    name: "Financeiro",
    badge: "Em desenvolvimento",
    desc: "Faturamento, contas, fluxo de caixa, DRE.",
  ...
  },
  {
    ...
    accent: "from-accent/40 to-secondary/30",
  },
  {
    id: "ia",
    to: "/produtos",
    ...
    accent: "from-primary/50 to-accent/40",
  },
];
    ...
    <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <Reveal>
        ...
        <p className="mt-6 max-w-3xl text-lg text-foreground/70">
          Cada produto Dioris compartilha a mesma fundação: autenticação, tenants, RBAC, IA, billing
          e storage. Ative o que precisar. Escale quando quiser.
        </p>
      </Reveal>
      <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((p, i) => (
          <Reveal key={p.id} delay={i * 0.04}>
            ...
            >
              <div
                className={`pointer-events-none absolute -right-20 -top-20 h-52 w-52 rounded-full bg-gradient-to-br ${p.accent} opacity-40 blur-3xl transition-opacity group-hover:opacity-70`}
              />
