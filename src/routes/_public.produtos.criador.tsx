...
export const Route = createFileRoute("/_public/produtos/criador")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sites, apps, sistemas, dashboards, CRMs e portais criados por IA.",
      },
...
const kinds = [
  { icon: Globe, t: "Sites" },
  { icon: FileCode, t: "Sistemas" },
  { icon: Smartphone, t: "Apps" },
  { icon: Sparkles, t: "Landing Pages" },
  { icon: LayoutDashboard, t: "Dashboards" },
  { icon: Building2, t: "CRM / ERP" },
  { icon: ShoppingBag, t: "Portais" },
  { icon: Wand2, t: "Ferramentas" },
];
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
        <Reveal>
          ...
          <p className="mt-6 text-lg text-foreground/70">
            Um único produto capaz de gerar sites, sistemas, apps, landing pages, dashboards, CRMs,
            ERPs e portais — integrados ao Core Dioris.
          </p>
      ...
      <Reveal>
        <div className="mt-24 rounded-3xl border border-white/10 bg-gradient-to-br from-accent/15 via-secondary/10 to-primary/15 p-10 lg:p-14">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            {[
              "Integrado ao Core (Auth, RBAC, IA, Storage)",
              "Créditos unificados com o restante da plataforma",
              "Templates prontos para verticais",
              "Extensível via SDK e plugins",
            ].map((b) => (
