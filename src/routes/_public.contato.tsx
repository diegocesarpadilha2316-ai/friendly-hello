...
export const Route = createFileRoute("/_public/contato")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Fale com o time da Dioris por email, WhatsApp ou formulário.",
      },
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-6 text-lg text-foreground/70">
            Estamos aqui para responder, demonstrar e apoiar sua adoção.
          </p>
        ...
        <Reveal delay={0.1}>
          ...
          >
            ...
            <div className="mt-6 space-y-4">
              ...
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary via-secondary to-accent px-6 py-3 text-sm font-semibold text-primary-foreground shadow-xl shadow-primary/40"
              >
