...
export const pluginPermissionsQuery = () =>
  queryOptions({ queryKey: sdkKeys.permissions(), queryFn: () => pluginPermissionsList(), staleTime: 60_000 });

export const pluginUpdatesQuery = () =>
  queryOptions({ queryKey: sdkKeys.updates(), queryFn: () => pluginUpdatesList(), staleTime: 30_000 });

export const marketplaceQuery = () =>
  queryOptions({ queryKey: sdkKeys.marketplace(), queryFn: () => marketplaceList(), staleTime: 300_000 });