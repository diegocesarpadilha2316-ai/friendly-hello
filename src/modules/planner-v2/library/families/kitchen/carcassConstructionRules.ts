...
export const GOLDEN_DRAWER_CARCASS_CONSTRUCTION_RULE: CarcassConstructionRule = {
  id: "kitchen-drawer-3:golden-carcass-between-sides",
  moduleDefinitionId: "kitchen-drawer-3",
  sideRelation: "full-height-above-toe-kick",
  baseRelation: "between-sides",
  topRelation: "between-sides-flush-with-top",
  backRelation: "between-sides-flush-with-rear",
