  ...
  return (
    <>
      <div className="floating-tools">
        ...
        <button onClick={() => setCameraAction('room')} title="Enquadrar Ambiente"><Camera size={16} /></button>
        <button onClick={() => setCameraAction('perspective')} title="Perspectiva"><Layout size={16} /></button>
        <button onClick={() => setCameraAction('front')} title="Vista Frontal"><Layers size={16} /></button>
        <button onClick={() => setCameraAction('top')} title="Vista Superior"><Eye size={16} /></button>
      </div>
