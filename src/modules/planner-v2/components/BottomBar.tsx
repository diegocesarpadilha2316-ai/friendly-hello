...
export const BottomBar: React.FC = () => {
  ...
  return (
    <footer className="h-[42px] bg-[#0A0B10] border-t border-[#2A2D3A] flex items-center justify-between px-4 text-[9px] text-[#94A3B8] shrink-0 select-none uppercase font-bold tracking-[0.2em] z-50">
