...
Estrutura reservada para o módulo **ai** da Dioris Hub.
...
- Componentes específicos do módulo ficam em `modules/ai/components`.
- Hooks específicos em `modules/ai/hooks`.
- Services específicos em `modules/ai/services`.
