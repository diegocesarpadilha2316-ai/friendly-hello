...
const DOMAINS: readonly DomainAudit[] = [
  ...
  { id: "editor-3d", label: "Editor 3D", status: "ok", notes: "Three.js/R3F com extrusão automática." },
  { id: "realtime", label: "Realtime Engine", status: "ok", notes: "FPS/Walk/Drone + física AABB." },
  { id: "render", label: "Render Engine", status: "ok", notes: "PBR + HDRI + integração real 4K/8K." },
  { id: "render-local", label: "Render Local", status: "ok", notes: "Motor determinístico próprio." },
  ...
  { id: "video-local", label: "Video Local", status: "ok", notes: "FFmpeg WASM + captura de frames." },
  { id: "ai", label: "IA Gateway", status: "ok", notes: "DeepSeek/OpenAI/Gemini/Claude/Mistral/OSS." },
  { id: "importer", label: "Importador CAD/BIM", status: "ok", notes: "DXF/OBJ/STL/GLTF/SVG." },
  { id: "library", label: "Biblioteca Oficial", status: "ok", notes: "26 serviços + 24 categorias." },
  { id: "library-premium", label: "Biblioteca Premium", status: "ok", notes: "18 fabricantes / 24 categorias." },
  { id: "marketplace", label: "Marketplace", status: "beta", notes: "Instalação local funcional." },
  { id: "catalog", label: "Catálogo Paramétrico", status: "ok", notes: "22 categorias com snapping." },
  { id: "configurator", label: "Configurador", status: "ok", notes: "Comandos pt-BR + camadas." },
  { id: "production", label: "Produção Inteligente", status: "ok", notes: "Studio Dark First completo." },
