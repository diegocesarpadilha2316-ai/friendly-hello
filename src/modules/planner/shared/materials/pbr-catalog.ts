...
const SEEDS: readonly CatalogSeed[] = [
  ...
  {
    id: "pbr:freijo-natural",
    name: "Freijó Natural",
    manufacturer: "Duratex",
    line: "Essencial Wood",
    category: "chapa",
    pattern: "Freijó Natural",
    colorHex: "#a67549",
  ...
  },
  {
    ...
    colorHex: "#b8895a",
    slug: "wood_table_worn",
    grain: "vertical",
    tileMm: [1250, 2500],
  },
  {
    id: "pbr:freijo-avelado",
    name: "Freijó Avelado",
    manufacturer: "Duratex",
    line: "Essencial Wood",
    category: "chapa",
    pattern: "Freijó Avelado",
    colorHex: "#8f5e34",
    slug: "wood_cabinet_worn_long",
    grain: "vertical",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:carvalho-natural",
    name: "Carvalho Naturale",
    manufacturer: "Arauco",
    line: "Trend",
    category: "chapa",
    pattern: "Carvalho Naturale",
    colorHex: "#c9a074",
    slug: "oak_veneer_01",
    grain: "vertical",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:carvalho-claro",
    name: "Carvalho Claro",
    manufacturer: "Arauco",
    line: "Trend",
    category: "chapa",
    pattern: "Carvalho Claro",
    colorHex: "#d6b48a",
    slug: "wood_table_001",
    grain: "vertical",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:carvalho-cinza",
    name: "Carvalho Cinza",
    manufacturer: "Arauco",
    line: "Trend",
    category: "chapa",
    pattern: "Carvalho Cinza",
    colorHex: "#8a8578",
    slug: "wood_planks_grey",
    grain: "vertical",
    tileMm: [1250, 2500],
  },
  {
    id: "pbr:carvalho-nordico",
    name: "Carvalho Nórdico",
    manufacturer: "Arauco",
    line: "Trend",
    category: "chapa",
    pattern: "Carvalho Nórdico",
    colorHex: "#c7b294",
    slug: "wood_table_001",
    grain: "vertical",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:preto-absoluto",
    name: "Preto Absoluto",
    manufacturer: "Duratex",
    line: "Absolutos",
    category: "chapa",
    pattern: "Preto Absoluto",
    colorHex: "#181818",
    slug: "painted_plaster_wall",
    grain: "livre",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:cinza-cristal",
    name: "Cinza Cristal",
    manufacturer: "Duratex",
    line: "Absolutos",
    category: "chapa",
    pattern: "Cinza Cristal",
    colorHex: "#a8adb2",
    slug: "painted_plaster_wall",
    grain: "livre",
    tileMm: [1250, 2500],
  ...
  {
    id: "pbr:calacatta",
    name: "Mármore Calacatta Bianco",
    manufacturer: "Dioris Stone",
    line: "Premium Marble",
    category: "tampo",
    pattern: "Calacatta Bianco",
    colorHex: "#efece5",
    slug: "marble_01",
    grain: "livre",
    tileMm: [3000, 1500],
  ...
  {
    id: "pbr:nero-marquina",
    name: "Nero Marquina",
    manufacturer: "Dioris Stone",
    line: "Premium Marble",
    category: "tampo",
    pattern: "Nero Marquina",
    colorHex: "#1a1a1a",
    slug: "marble_01",
    grain: "livre",
    tileMm: [3000, 1500],
  ...
  {
    id: "pbr:branco-absoluto-quartzo",
    name: "Quartzo Branco Absoluto",
    manufacturer: "Silestone",
    line: "Quartz",
    category: "tampo",
    pattern: "Branco Absoluto",
    colorHex: "#f6f4ef",
    slug: "marble_01",
    grain: "livre",
    tileMm: [3000, 1500],
  ...
  {
    id: "pbr:cinza-concreto-tampo",
    name: "Quartzo Cinza Concreto",
    manufacturer: "Silestone",
    line: "Quartz",
    category: "tampo",
    pattern: "Cinza Concreto",
    colorHex: "#8b8b86",
  ...
  {
    id: "pbr:granito-preto-sao-gabriel",
    name: "Granito Preto São Gabriel",
    manufacturer: "Dioris Stone",
    line: "Granite",
    category: "tampo",
    pattern: "Preto São Gabriel",
    colorHex: "#242424",
    slug: "marble_01",
    grain: "livre",
    tileMm: [3000, 1500],
  ...
  // ─── REVESTIMENTOS DE PAREDE ──────────────────────────────────────────────
  {
    ...
    manufacturer: "Dioris Wall",
    line: "Industrial",
    category: "revestimento",
    pattern: "Concreto Cinza",
    colorHex: "#8f8b84",
    slug: "concrete_wall_007",
    grain: "livre",
    tileMm: [3000, 3000],
  ...
  {
    id: "pbr:pedra-parede",
    name: "Revestimento Pedra Natural",
    manufacturer: "Dioris Wall",
    line: "Stone Wall",
    category: "revestimento",
    pattern: "Pedra Natural",
    colorHex: "#a89e8c",
    slug: "stone_tile_wall",
    grain: "livre",
    tileMm: [1500, 1500],
  ...
  {
    id: "pbr:tijolo-branco",
    name: "Tijolo Branco Aparente",
    manufacturer: "Dioris Wall",
    line: "Rustic",
    category: "revestimento",
    pattern: "Tijolo Branco",
    colorHex: "#e6dfd4",
    slug: "red_brick_03",
    grain: "horizontal",
    tileMm: [1500, 1500],
  ...
  {
    id: "pbr:tijolo-vermelho",
    name: "Tijolo Vermelho Rústico",
    manufacturer: "Dioris Wall",
    line: "Rustic",
    category: "revestimento",
    pattern: "Tijolo Vermelho",
    colorHex: "#8b4a3a",
    slug: "red_brick_03",
    grain: "horizontal",
    tileMm: [1500, 1500],
  ...
  // ─── PISOS ────────────────────────────────────────────────────────────────
  {
    id: "pbr:piso-carvalho",
    name: "Piso Carvalho Escovado",
    manufacturer: "Durafloor",
    line: "Wood Flooring",
    category: "piso",
    pattern: "Piso Carvalho",
    colorHex: "#b6875a",
    slug: "wood_floor",
    grain: "vertical",
    tileMm: [2000, 4000],
  ...
  {
    id: "pbr:piso-laminado",
    name: "Piso Laminado Freijó",
    manufacturer: "Durafloor",
    line: "Laminate",
    category: "piso",
    pattern: "Laminado Freijó",
    colorHex: "#a67f52",
  ...
  {
    id: "pbr:piso-porcelanato-marmore",
    name: "Porcelanato Calacatta",
    manufacturer: "Portobello",
    line: "Ceramica",
    category: "piso",
    pattern: "Porcelanato Calacatta",
    colorHex: "#eeeae2",
    slug: "marble_01",
    grain: "livre",
    tileMm: [1200, 1200],
  ...
  {
    id: "pbr:piso-terracota",
    name: "Piso Terracota Rústico",
    manufacturer: "Portobello",
    line: "Rustic",
    category: "piso",
    pattern: "Terracota",
  ...
  // ─── TECIDOS (Estofados / Cortinas) ───────────────────────────────────────
  {
    id: "pbr:linho-cru",
    name: "Linho Cru",
    manufacturer: "Dioris Textil",
    line: "Estofados",
    category: "revestimento",
    pattern: "Linho Cru",
    colorHex: "#d8ccb6",
    slug: "fabric_pattern_07",
    grain: "livre",
    tileMm: [800, 800],
    roughnessBias: 0.35,
  },
  {
    id: "pbr:boucle-off",
    name: "Bouclê Off White",
    manufacturer: "Dioris Textil",
    line: "Estofados",
    category: "revestimento",
    pattern: "Bouclê Off White",
    colorHex: "#ede4d4",
    slug: "fabric_pattern_07",
    grain: "livre",
    tileMm: [800, 800],
  ...
  {
    id: "pbr:veludo-verde",
    name: "Veludo Verde Musgo",
    manufacturer: "Dioris Textil",
    line: "Estofados",
    category: "revestimento",
    pattern: "Veludo Musgo",
    colorHex: "#3d5040",
    slug: "fabric_pattern_07",
    grain: "livre",
    tileMm: [800, 800],
  ...
  {
    id: "pbr:veludo-terracota",
    name: "Veludo Terracota",
    manufacturer: "Dioris Textil",
    line: "Estofados",
    category: "revestimento",
    pattern: "Veludo Terracota",
    colorHex: "#9c4e35",
    slug: "fabric_pattern_07",
    grain: "livre",
    tileMm: [800, 800],
  ...
  // ─── METAIS ───────────────────────────────────────────────────────────────
  {
    ...
    manufacturer: "Dioris Metal",
    line: "Metal",
    category: "metal",
    pattern: "Aço Escovado",
    colorHex: "#c8ccd0",
    slug: "metal_plate",
    grain: "horizontal",
    tileMm: [600, 1200],
  ...
  {
    id: "pbr:latao-escovado",
    name: "Latão Escovado",
    manufacturer: "Dioris Metal",
    line: "Metal",
    category: "metal",
    pattern: "Latão Escovado",
    colorHex: "#b89968",
    slug: "metal_plate",
    grain: "horizontal",
    tileMm: [600, 1200],
  ...
  {
    id: "pbr:preto-fosco-metal",
    name: "Metal Preto Fosco",
    manufacturer: "Dioris Metal",
    line: "Metal",
    category: "metal",
    pattern: "Preto Fosco",
