...
export function normalizeKitchenModule(input: KitchenModuleInput = {}): KitchenModuleSpec {
  ...
  const doors =
    opening === "aberto" || opening === "gaveta" ? 0 : int(input.doors, autoDoors, 0, 6);
