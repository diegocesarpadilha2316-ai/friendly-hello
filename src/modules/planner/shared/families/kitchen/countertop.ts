...
export const COUNTERTOPS: Readonly<Record<CountertopMaterial, CountertopProfileDef>> = {
  ...
  marmore: {
    ...
    thicknessMm: 20,
    overhangFrontMm: 20,
    finishId: "marmore-carrara",
    acceptsCutout: true,
  },
  "pedra-sinterizada": {
    id: "pedra-sinterizada",
    label: "Pedra sinterizada",
    thicknessMm: 12,
    overhangFrontMm: 15,
    finishId: "dekton-cinza",
    acceptsCutout: true,
  },
  madeira: {
    id: "madeira",
  ...
  inox: {
    ...
    thicknessMm: 15,
    overhangFrontMm: 10,
    finishId: "inox-escovado",
    acceptsCutout: true,
  },
  laminado: {
    id: "laminado",
    label: "Laminado pós-formado",
    thicknessMm: 38,
    overhangFrontMm: 20,
    finishId: "laminado-branco",
    acceptsCutout: false,
  },
  vidro: {
    id: "vidro",
...
export function normalizeCountertop(
  ...
  return {
    ...
    overhangFrontMm:
      mat === "nenhum" ? 0 : clampNum(input?.overhangFrontMm, def.overhangFrontMm, 0, 120),
