...
export const LAUNDRY_MODULE_PROFILES: Readonly<Record<LaundryModuleKind, LaundryModuleProfile>> = {
  ...
  "gabinete-inferior": {
    ...
    drawers: 0,
    shelves: 1,
    label: "Gabinete inferior simples",
  },
  "gabinete-2-portas": {
    ...G,
    defaultWidthMm: 900,
    ...
    drawers: 0,
    shelves: 1,
    label: "Gabinete com duas portas",
  },
  "gabinete-gavetas": {
    ...G,
    opening: "gaveta",
  ...
  "gabinete-cesto-basculante": {
    ...
    drawers: 0,
    shelves: 0,
    label: "Gabinete com cesto basculante",
  },
  "modulo-lavadora": {
    ...G,
    opening: "aberto",
    ...
    defaultDepthMm: 750,
    minWidthMm: 600,
    appliance: "lavadora-frontal",
    doors: 0,
    drawers: 0,
    shelves: 0,
    label: "Módulo para máquina de lavar",
  },
  "modulo-secadora": {
    ...G,
    opening: "aberto",
    ...
    drawers: 0,
    shelves: 0,
    label: "Módulo para secadora",
  },
  "modulo-lava-e-seca": {
    ...G,
    opening: "aberto",
    defaultWidthMm: 700,
    defaultHeightMm: 1020,
    defaultDepthMm: 780,
    minWidthMm: 600,
    appliance: "lava-e-seca",
    doors: 0,
    drawers: 0,
    shelves: 0,
    label: "Módulo para lava e seca",
  },
  "torre-maquinas": {
    ...G,
    level: "coluna",
  ...
  "aereo-portas": {
    ...
    drawers: 0,
    shelves: 1,
    label: "Armário aéreo com portas",
  },
  "nicho-aberto": {
    ...G,
    level: "superior",
  ...
  "modulo-produtos": {
    ...
    drawers: 0,
    shelves: 3,
    label: "Módulo para produtos de limpeza",
  },
  "modulo-tabua": {
    ...G,
    level: "coluna",
    ...
    drawers: 0,
    shelves: 0,
    label: "Módulo para tábua de passar",
  },
  "modulo-cestos": {
    ...G,
    opening: "aberto",
    ...
    drawers: 0,
    shelves: 2,
    label: "Módulo para cestos removíveis",
  },
  "tapa-vao": {
    ...G,
    level: "acabamento",
  ...
  "tampo-continuo": {
    ...
    drawers: 0,
    shelves: 0,
    label: "Tampo contínuo",
  },
  "bancada-sobre-maquina": {
    ...G,
    opening: "aberto",
    defaultWidthMm: 700,
    defaultHeightMm: 1050,
    defaultDepthMm: 750,
    minWidthMm: 600,
    countertop: true,
    appliance: "lavadora-frontal",
    ...
    drawers: 0,
    shelves: 0,
    label: "Bancada sobre máquina frontal",
  },
};
...
export function normalizeLaundryModule(input: LaundryModuleInput = {}): LaundryModuleSpec {
  ...
  const tub = normalizeTub({ type: p.tub, ...defined(input.tub) }, wantsTub, {
  ...
  return {
    ...
    drawers:
      opening === "abrir" || opening === "aberto" || opening === "cesto" ? 0 : requestedDrawers,
    ...
    board,
    broomZoneMm: p.broomZone
      ? int(input.broomZoneMm, 1400, 600, 2400)
      : int(input.broomZoneMm, 0, 0, 2400),
