...
export const ROOM_BUCKETS: readonly RoomBucket[] = [
  { id: "cozinha",       label: "Cozinha",       subtypes: ["balcao","aereo","torre","gaveteiro","tampo","bancada","ilha","cristaleira","cooktop","fogao","forno","coifa","microondas","lava-loucas","adega","geladeira","cuba","torneira"], contexts: ["cozinha"] },
  { id: "closet",        label: "Closet",        subtypes: ["closet","roupeiro","cristaleira","gaveteiro"], contexts: ["closet"] },
  { id: "dormitorio",    label: "Dormitório",    subtypes: ["roupeiro","cama","criado-mudo","painel","aereo"], contexts: ["dormitorio"] },
  { id: "banheiro",      label: "Banheiro",      subtypes: ["cuba","torneira","vaso-sanitario","chuveiro","banheira","espelho","balcao","gaveteiro"], contexts: ["banheiro"] },
  { id: "lavanderia",    label: "Lavanderia",    subtypes: ["balcao","aereo","tampo","cuba","lava-roupas"], contexts: ["lavanderia","area-servico"] },
  { id: "home-office",   label: "Home Office",   subtypes: ["mesa","cadeira","estante","painel","balcao","aereo"], contexts: ["escritorio","home-office"] },
  { id: "sala",          label: "Sala",          subtypes: ["painel","cristaleira","nicho","sofa","mesa","aparador","estante","tv","poltrona"], contexts: ["sala","estar"] },
  ...
  { id: "iluminacao",    label: "Iluminação",    subtypes: ["iluminacao","luminaria","pendente","arandela","spot"] },
  { id: "decoracao",     label: "Decoração",     subtypes: ["tapete","cortina","persiana","quadro","vaso-planta","planta","livro","objeto-deco"] },
];
...
export function bucketsFor(item: CatalogItem): string[] {
  ...
  for (const b of ROOM_BUCKETS) {
    if ((b.subtypes as readonly string[]).includes(st)) { hits.push(b.id); continue; }
