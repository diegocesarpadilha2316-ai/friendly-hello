...
export const CATALOG_SLIDES: readonly CatalogSlide[] = [
  ...
  {
    id: "slide-hettich-innotech-500",
    name: "Hettich InnoTech 500",
  ...
  {
    id: "slide-fgv-telescopica-500",
    name: "FGV Telescópica 500",
    manufacturer: "fgv",
    kind: "telescopica",
    lengthMm: 500,
    loadKg: 35,
  ...
  {
    id: "slide-hafele-sincro",
    name: "Häfele Sincronizada 500",
    manufacturer: "hafele",
    kind: "sincronizada",
    lengthMm: 500,
    loadKg: 30,
