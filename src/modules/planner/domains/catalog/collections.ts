...
export const CATALOG_COLLECTIONS: readonly CatalogCollection[] = [
  {
    id: "col-dioris-signature",
    name: "Signature",
    manufacturer: "dioris",
    line: "Premium",
    year: 2026,
    tags: ["premium", "assinatura"],
  },
  {
    id: "col-dioris-essence",
    name: "Essence",
    manufacturer: "dioris",
    line: "Core",
    year: 2026,
