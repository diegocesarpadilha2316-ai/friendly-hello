...
export const PBR_MATERIALS: readonly PbrMaterial[] = [
  makeMaterial({
    id: "pbr.madeira.carvalho",
    family: "madeira",
    label: "Carvalho Natural",
    baseColorHex: "#a67c52",
    roughness: 0.55,
    tags: ["quente", "premium"],
  }),
  makeMaterial({
    id: "pbr.madeira.freijo",
    family: "madeira",
    label: "Freijó Escovado",
    baseColorHex: "#7a4b2a",
    roughness: 0.6,
    tags: ["quente"],
  }),
  ...
  makeMaterial({
    id: "pbr.mdp.cinza",
    family: "mdp",
    label: "MDP Cinza Cristal",
    baseColorHex: "#b8b8b8",
    roughness: 0.55,
  }),
  makeMaterial({
    id: "pbr.laca.fosca.preta",
    family: "laca",
    label: "Laca Fosca Preta",
    baseColorHex: "#0f0f10",
    roughness: 0.35,
  }),
  makeMaterial({
    id: "pbr.laca.brilho.branca",
    family: "laca",
    label: "Laca Brilho Branca",
    baseColorHex: "#ffffff",
    roughness: 0.05,
  }),
  makeMaterial({
    id: "pbr.vidro.temperado",
    family: "vidro",
  ...
  makeMaterial({
    id: "pbr.metal.dourado",
    family: "metal",
    label: "Metal Dourado Escovado",
    baseColorHex: "#c9a24a",
    roughness: 0.3,
    metallic: 1,
  }),
  ...
  makeMaterial({
    id: "pbr.inox",
    family: "inox",
    label: "Aço Inox Escovado",
    baseColorHex: "#c8ccd0",
    roughness: 0.28,
    metallic: 1,
  }),
  makeMaterial({
    id: "pbr.pedra.travertino",
    family: "pedra",
    label: "Travertino Bege",
    baseColorHex: "#c9b394",
    roughness: 0.7,
  }),
  makeMaterial({
    id: "pbr.granito.preto",
    family: "granito",
    label: "Granito São Gabriel",
    baseColorHex: "#2a2a2a",
    roughness: 0.4,
  }),
  makeMaterial({
    id: "pbr.marmore.carrara",
    family: "marmore",
  ...
  makeMaterial({
    id: "pbr.marmore.calacatta",
    family: "marmore",
    label: "Mármore Calacatta",
    baseColorHex: "#f2eee5",
    roughness: 0.18,
  }),
  makeMaterial({
    id: "pbr.quartzo.branco",
    family: "quartzo",
    label: "Quartzo Branco Absoluto",
    baseColorHex: "#f4f4f2",
    roughness: 0.15,
  }),
  makeMaterial({
    id: "pbr.porcelanato.cinza",
    family: "porcelanato",
    label: "Porcelanato Cinza 120×120",
    baseColorHex: "#9a9a9a",
    roughness: 0.25,
  }),
  makeMaterial({
  ...
  makeMaterial({
    id: "pbr.tecido.veludo",
    family: "tecido",
    label: "Veludo Verde Musgo",
    baseColorHex: "#3f5d43",
    roughness: 0.85,
  }),
  makeMaterial({
    id: "pbr.couro.caramelo",
    family: "couro",
    label: "Couro Caramelo",
    baseColorHex: "#8a5a2b",
    roughness: 0.7,
  }),
];
