...
export const REALTIME_PROPS: readonly RealtimeAssetItem[] = [
  ...
  {
    id: "prop-livros-linha",
    label: "Livros em Fila",
    category: "livros",
    widthMm: 600,
    heightMm: 240,
    depthMm: 200,
