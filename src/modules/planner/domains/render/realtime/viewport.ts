...
export function applyViewportMode(
  state: RealtimeViewportState,
  mode: RealtimeViewportMode,
): RealtimeViewportState {
  if (mode === "cliente")
    return {
      ...state,
...
export function setTime(s: RealtimeViewportState, time: RealtimeTimeOfDay): RealtimeViewportState {
  return { ...s, time };
}
