...
export function openDrawer(d: RealtimeDrawerState): RealtimeDrawerState { return { ...d, openRatio: 1 }; }
export function closeDrawer(d: RealtimeDrawerState): RealtimeDrawerState { return { ...d, openRatio: 0 }; }
...
export function upsertDrawer(list: readonly RealtimeDrawerState[], drawer: RealtimeDrawerState): readonly RealtimeDrawerState[] {
