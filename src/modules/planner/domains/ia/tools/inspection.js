...
export function checkCirculation(project, ctx) {
    ...
    const note = "Portas e janelas ainda não são modeladas como aberturas no cômodo; a análise considera apenas o footprint dos módulos e as dimensões do ambiente.";
    return {
...
export function reviewProject(project, ctx) {
    ...
    if (structural.length > 0) {
        findings.push({
            ...
            description: "Fita de borda, sentido do veio, folgas e usinagem ainda usam os padrões da empresa, não valores confirmados por módulo.",
