...
function scopeOf(args) {
    ...
    const n = norm(raw);
    if (n.includes("port") || n.includes("frente") || n.includes("front"))
        return "frentes";
    if (n.includes("tampo") || n.includes("bancada"))
        return "tampo";
    if (n.includes("piso"))
        return "piso";
    if (n.includes("aereo"))
        return "aereos";
    if (n.includes("balcao"))
        return "balcoes";
    return "corpo";
}
export function extractMemory(input) {
    ...
    if (typeof styleFromTool === "string")
        style = norm(styleFromTool);
    else {
    ...
    if (/producao|corte|chapa|marcenaria industrial/.test(text) &&
