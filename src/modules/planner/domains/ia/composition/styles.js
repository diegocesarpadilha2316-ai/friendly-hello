...
export const STYLE_PROFILES = {
    ...
    contemporaneo: P("contemporaneo", 1.05, 20, {
    ...
    minimalista: P("minimalista", 0.6, 30, {
    ...
    industrial: P("industrial", 0.85, 16, {
