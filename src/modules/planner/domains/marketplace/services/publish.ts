...
const SEEDS: readonly Seed[] = [
  {
    ...
    category: "cozinhas",
    catalog: "armario",
    catalogBrand: "duratex",
    collectionId: "col-duratex-arya",
    authorId: "aut-duratex",
    company: "Duratex",
    version: "1.4.0",
    license: "free",
  ...
  },
  {
    ...
    category: "cozinhas",
    catalog: "aereo",
    catalogBrand: "guararapes",
    authorId: "aut-guararapes",
    company: "Guararapes",
    version: "1.1.0",
    license: "free",
    pricing: pricing("free"),
  ...
  },
  {
    ...
    catalog: "closet",
    catalogBrand: "berneck",
    authorId: "aut-berneck",
    company: "Berneck",
    version: "1.0.2",
    license: "free",
    pricing: pricing("free"),
  ...
  },
  {
    ...
    version: "3.2.0",
    license: "premium",
    pricing: pricing("paid", 189),
    downloads: 9820,
    ratingAvg: 4.9,
    ratingCount: 612,
    favorites: 1420,
    tags: ["gaveta", "blum", "premium"],
    featured: true,
    defaults: {
      widthMm: 800,
      heightMm: 200,
  ...
  },
  {
    ...
    category: "ferragens",
    catalog: "ferragem",
    catalogBrand: "hettich",
    authorId: "aut-hettich",
    company: "Hettich",
    version: "1.5.0",
    license: "premium",
    pricing: pricing("paid", 149),
    downloads: 4210,
    ratingAvg: 4.7,
    ratingCount: 218,
    favorites: 512,
  ...
  },
  {
    ...
    version: "1.0.0",
    license: "marketplace",
    pricing: pricing("paid", 349),
    downloads: 3820,
    ratingAvg: 4.9,
    ratingCount: 210,
    favorites: 890,
    tags: ["ambiente", "loft", "premium"],
    featured: true,
