...
export const MARKETPLACE_SYNC_TARGETS: readonly MarketplaceSyncTarget[] = [
  {
    id: "marketplace-dioris",
    label: "Marketplace Dioris",
    description: "Distribuição oficial Dioris",
    plannerVersion: PLANNER_VERSION,
  },
  {
    id: "erp",
    label: "ERP",
    description: "Sincronização com o ERP da empresa",
    plannerVersion: PLANNER_VERSION,
  },
  {
    id: "distribuidor",
    label: "Distribuidor",
    description: "Rede de distribuidores homologados",
    plannerVersion: PLANNER_VERSION,
  },
  {
    id: "fabricante",
    label: "Fabricante",
    description: "Portal do fabricante",
    plannerVersion: PLANNER_VERSION,
  },
];
...
export function buildManifest(
  target: MarketplaceSyncTarget["id"],
  items: readonly MarketplaceItem[],
): MarketplaceSyncManifest {
