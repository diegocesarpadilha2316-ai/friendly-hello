...
export const SCENE_PRESETS: readonly VideoScenePreset[] = [
  {
    id: "scene-apresentacao",
    kind: "apresentacao",
    label: "Apresentação",
    description: "Tour cinemático completo — orbital, walk through, close nas ferragens.",
    durationSec: 45,
    aspectRatio: "16:9",
    recommendedFormatIds: ["fmt-fhd-16-9", "fmt-4k-16-9"],
    usage: ["Reunião", "Vistoria", "Portfólio"],
  },
  {
    id: "scene-cliente",
    kind: "cliente",
    label: "Cliente",
    description: "Vídeo dedicado ao cliente — narração + close nos móveis + LEDs.",
    durationSec: 60,
    aspectRatio: "16:9",
    recommendedFormatIds: ["fmt-fhd-16-9"],
    usage: ["Envio pessoal", "WhatsApp", "E-mail"],
  },
  {
    id: "scene-marketing",
    kind: "marketing",
    label: "Marketing",
    description: "Vinheta com marca — orbital rápido, corte seco, chamada final.",
    durationSec: 30,
    aspectRatio: "16:9",
    recommendedFormatIds: ["fmt-4k-16-9", "fmt-8k-16-9"],
    usage: ["Site", "LinkedIn", "Google Ads"],
  },
  {
    id: "scene-instagram",
    kind: "instagram",
    label: "Instagram Feed",
    description: "Vertical 4:5 curto — 3 planos rápidos e branding final.",
    durationSec: 20,
    aspectRatio: "4:5",
    recommendedFormatIds: ["fmt-fhd-4-5"],
    usage: ["Feed", "Carrossel de vídeo"],
  },
  {
    id: "scene-reels",
    kind: "reels",
    label: "Reels / TikTok",
    description: "Vertical 9:16 dinâmico — cortes rápidos, câmera automática, legenda.",
    durationSec: 15,
    aspectRatio: "9:16",
    recommendedFormatIds: ["fmt-fhd-9-16", "fmt-4k-9-16"],
  ...
  },
  {
    ...
    kind: "youtube",
    label: "YouTube",
    description: "Horizontal 16:9 longo — tour completo com narração e trilha.",
    durationSec: 90,
    aspectRatio: "16:9",
    recommendedFormatIds: ["fmt-4k-16-9"],
    usage: ["YouTube", "Blog", "Case"],
  },
  {
    id: "scene-catalogo",
    kind: "catalogo",
    label: "Catálogo",
    description: "Foco no produto — orbital + explode + ferragens + estrutura.",
    durationSec: 25,
    aspectRatio: "1:1",
    recommendedFormatIds: ["fmt-fhd-1-1"],
    usage: ["E-commerce", "Ficha técnica", "Showroom digital"],
  },
];
