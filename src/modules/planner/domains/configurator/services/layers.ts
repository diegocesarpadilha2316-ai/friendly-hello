...
export const CONFIGURATOR_LAYERS: readonly ConfiguratorLayer[] = [
  {
    ...
    label: "Estrutura",
    color: "hsl(210 90% 60%)",
    description: "Laterais, fundos, prateleiras, divisórias",
  },
  {
    id: "portas",
    label: "Portas",
    color: "hsl(160 70% 50%)",
    description: "Frentes de porta com dobradiças",
  },
  {
    id: "gavetas",
    label: "Gavetas",
    color: "hsl(30 90% 60%)",
    description: "Frentes e caixas de gaveta",
  },
  {
    id: "ferragens",
    label: "Ferragens",
    color: "hsl(280 70% 65%)",
    description: "Puxadores, dobradiças, corrediças",
  },
  {
    id: "vidros",
    label: "Vidros",
    color: "hsl(190 80% 65%)",
    description: "Portas e prateleiras de vidro",
  },
  {
    id: "espelhos",
    label: "Espelhos",
    color: "hsl(220 30% 80%)",
    description: "Painéis espelhados",
  },
  { id: "led", label: "LED", color: "hsl(50 100% 60%)", description: "Iluminação integrada" },
  {
    ...
    label: "Decoração",
    color: "hsl(340 80% 65%)",
    description: "Objetos decorativos e cortesia",
  },
  {
    id: "producao",
    label: "Produção",
    color: "hsl(0 0% 65%)",
    description: "Marcações e overlays de fábrica",
  },
];
...
export function countByLayer(
  nodes: readonly PlannerParametricNode[],
): Record<ConfiguratorLayerId, number> {
