...
export const FACTORY_OPERATORS: readonly FactoryOperator[] = [
  ...
  },
  {
    ...
    name: "Marina Alves",
    shift: "manha",
    skills: ["montagem", "acabamento", "conferencia"],
    efficiency: 0.95,
    loadH: 5.5,
    status: "ocupado",
  },
  {
    ...
    name: "Rafael Lima",
    shift: "tarde",
    skills: ["corte", "usinagem", "montagem"],
    efficiency: 0.88,
    loadH: 3,
    status: "disponivel",
  },
  {
    ...
    name: "Bianca Rocha",
    shift: "tarde",
    skills: ["conferencia", "embalagem", "logistica"],
    efficiency: 0.9,
    loadH: 2,
    status: "disponivel",
  },
...
export function buildCapacitySnapshot(
  ...
  const utilizationPct =
    dailyCapacityH === 0 ? 0 : Math.min(100, Math.round((demandH / dailyCapacityH) * 100));
  const daysToComplete =
    dailyCapacityH === 0 ? 0 : Math.max(1, Math.ceil(demandH / dailyCapacityH));
  return {
