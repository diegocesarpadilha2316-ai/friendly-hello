...
export const DEFAULT_RESOURCES: readonly PlanningResource[] = [
  ...
  },
  {
    ...
    hoursPerDay: 8,
    status: "ativo",
    skills: ["colagem", "lixamento"],
  },
  {
    id: "res-setor-corte",
    kind: "setor",
    label: "Setor de Corte",
    sector: "Corte",
    hoursPerDay: 16,
    status: "ativo",
  },
  {
    id: "res-setor-usinagem",
    kind: "setor",
    label: "Setor de Usinagem",
    sector: "Usinagem",
    hoursPerDay: 16,
    status: "ativo",
  },
  {
    id: "res-setor-montagem",
    kind: "setor",
    label: "Setor de Montagem",
    sector: "Montagem",
    hoursPerDay: 16,
    status: "ativo",
  },
