...
export function buildIndustrialCost(
  ...
  const mao =
    groupSum("mao-obra") + groupSum("pintura") + groupSum("montagem") + groupSum("entrega");
  ...
  const rows: IndustrialCostRow[] = [
    {
      id: "material",
      group: "material",
      label: "Chapas e revestimentos",
      value: material,
      hint: "MDF, MDP, fita de borda",
    },
    {
      id: "ferragens",
      group: "ferragens",
      ...
      value: ferragens,
      hint: "dobradiças, corrediças, minifix",
    },
    {
      id: "mao",
      group: "mao-obra",
      label: "Mão de obra + pintura + montagem",
      value: mao,
      hint: `${report.time.totalH}h totais`,
    },
    {
      id: "desp",
      group: "desperdicio",
      label: "Desperdício de chapa",
      value: wasteCost,
      hint: `${wasteM2.toFixed(2)} m² à R$80/m²`,
    },
    {
      id: "overhead",
      group: "overhead",
      label: `Overhead ${b.parameters.overheadPct}%`,
      value: overhead,
      hint: "custos fixos rateados",
    },
    {
      id: "lucro",
      group: "lucro",
      label: `Margem ${b.parameters.marginPct}%`,
      value: margin,
      hint: "lucro esperado",
    },
    {
      id: "imposto",
      group: "imposto",
      label: `Impostos ${b.parameters.taxPct}%`,
      value: taxes,
      hint: "carga tributária",
    },
  ];
