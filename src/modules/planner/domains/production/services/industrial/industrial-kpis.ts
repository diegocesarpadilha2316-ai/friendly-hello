...
export function buildIndustrialKpis(
  ...
  return [
    ...
    },
    {
      id: "sobras",
      label: "Sobras úteis",
      value: `${offcuts.length}`,
      hint: `${offcutM2.toFixed(2)} m² estocados`,
      tone: offcuts.length > 0 ? "success" : "muted",
    },
    {
      id: "aproveit",
      ...
      tone: usagePct >= 75 ? "success" : "warning",
    },
    {
      id: "prod",
      label: "Fila de produção",
      value: `${report.totals.modules}`,
      hint: "módulos prontos p/ fábrica",
      tone: "info",
    },
    {
      id: "tempo",
    ...
    },
    {
      id: "area",
      label: "Área total",
      value: `${report.parts.reduce((a, p) => a + p.areaM2 * p.qty, 0).toFixed(2)} m²`,
      hint: "chapa consumida",
      tone: "muted",
    },
    {
      id: "custo",
      label: "Custo estimado",
      value: fmtBRL(cost.cost),
      hint: `${fmtBRL(cost.costPerM2)}/m²`,
      tone: "warning",
    },
    {
      id: "lucro",
      label: "Lucro esperado",
      value: fmtBRL(cost.margin),
      hint: `margem ${cost.marginPct}%`,
      tone: "success",
    },
    {
      id: "final",
      label: "Preço final",
      value: fmtBRL(cost.final),
      hint: `${fmtBRL(cost.pricePerM2)}/m²`,
      tone: "success",
    },
  ];
}
