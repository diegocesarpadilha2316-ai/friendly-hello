  ...
  return (
    <header className="dioris-topbar">
      ...
      <nav className="dioris-toolbar" aria-label="CAD Tools">
        ...
        <Tool label="Salvar" onClick={props.onSave}>
          <Save size={14} />
        </Tool>
        <div className="dioris-divider" />
        <Tool label="Desfazer" onClick={props.onUndo}>
          <Undo2 size={14} />
        </Tool>
        <Tool label="Refazer" onClick={props.onRedo}>
          <Redo2 size={14} />
        </Tool>
        <div className="dioris-divider" />
        <Tool
        ...
        <div className="dioris-divider" />
        <Tool label="Render" onClick={props.onRender}>
          <Camera size={14} />
        </Tool>
        <Tool label="Planta" onClick={props.onOpenFloorPlan}>
          <Grid2X2 size={14} />
        </Tool>
        <Tool label="Corte" onClick={props.onOpenCutList}>
          <ListTree size={14} />
        </Tool>
        <Tool label="Custos" onClick={props.onOpenBudget}>
          <Calculator size={14} />
        </Tool>
      </nav>
